IF EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'DWH' AND TABLE_NAME = 'V_Demo2_Absences') DROP EXTERNAL TABLE [DWH].[V_Demo2_Absences] ;
	...
	SET @prmDynamicSQL1 = '
    CREATE EXTERNAL TABLE [DWH].[V_Demo2_Absences] 
